            ...
            <div className="p-10">
              <div className="flex justify-between items-center mb-10">
                <div>
                  ...
                  <h2 className="text-3xl font-bold text-tech-slate font-jakarta">Register Vehicle</h2>
                </div>
                <button 
                  onClick={onClose}
                   ...
                   <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full pl-12 pr-4 py-4 bg-slate-50 rounded-2xl border border-transparent focus:border-blue-100 focus:bg-white transition-all text-sm outline-none"
                        />
                      </div>
                   </div>
                   <div className="space-y-2">
                      ...
                      <div className="relative">
                        ...
                        <input 
                          ...
                          className="w-full pl-12 pr-4 py-4 bg-slate-50 rounded-2xl border border-transparent focus:border-blue-100 focus:bg-white transition-all text-sm outline-none font-mono"
                        />
                      </div>
                   </div>
                </div>
