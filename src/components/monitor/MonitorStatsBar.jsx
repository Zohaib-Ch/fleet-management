...
import { 
  ...
  Wrench, AlertTriangle, TrendingUp, ClipboardCheck, Calendar, 
  ...
  return (
    <div className="relative flex items-center gap-4 py-2">
      ...
      <motion.button
        ...
        className={`shrink-0 w-12 h-12 rounded-2xl flex items-center justify-center transition-all border ${
          showConfig
                ...
                return (
                  ...
                  >
                    ...
                    <div className={`w-5 h-5 rounded-lg flex items-center justify-center border-2 transition-all ${
                      stat.visible ? 'bg-blue-600 border-blue-600 scale-110' : 'border-slate-200'
                    }`}>
